...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // ⭐ تم شيل شرط status !== 'completed' (كان بيمنع الرجوع الإجباري لشاشة التقييم)
    // ⭐ الاعتماد بقى بس على !order.clientDismissed لتحديد هل العميل خلص فعلاً من الطلب المكتمل
  ...
  // ⭐ تم شيل شرط status !== 'completed' لنفس السبب أعلاه (اتساق العدّاد مع منطق الترشيح التلقائي)
